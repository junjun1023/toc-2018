...
# rice west
    ...
    recommmend_rice_store_in_west = {
        'OMHUT': {
            'disc': '人氣很高的店，日式口味咖哩雞很不錯吃，問吧是每天的變化性餐點，建議外帶為主，可於開店前半小時致電訂餐',
            'img': 'https://i.imgur.com/sivcw5y.jpg'},
        '矮仔成': {
...
# snack west
    ...
    recommmend_snack_store_in_west = {
        '康宇家': {
            'disc': '主打茶系列的霜淇淋，抹茶味不會很重，怕抹茶的人也能接受的味道',
            'img': 'https://i.imgur.com/o7Oj48x.jpg'},
        '甜在心': {
            'disc': '好吃又美拍的車輪餅，薄脆的外皮，滿滿的內餡，奶油經典口味，花生帶顆粒也很不錯，店家時不時會推出特殊口味',
